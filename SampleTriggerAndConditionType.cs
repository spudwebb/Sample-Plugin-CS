...
namespace HSPI_HomeSeerSamplePlugin {
    ...
    /// </summary>
    public class SampleTriggerAndConditionType : AbstractTriggerType {

        /// <summary>
        /// The 1 based index of this trigger type. Used for reference in this class.
        /// </summary>
        public const int TriggerNumber = 2;

        /// <summary>
        /// The name of this trigger in the list of available triggers on the event page
        /// </summary>
        private const string TriggerName = "Sample Trigger And Condition";
        ...
        /// <inheritdoc />
        public SampleTriggerAndConditionType(TrigActInfo trigInfo, TriggerTypeCollection.ITriggerTypeListener listener, bool logDebug = false) : base(trigInfo, listener, logDebug) { }
        /// <inheritdoc />
        /// <remarks>
        /// All trigger types must implement this constructor
        /// </remarks>
        public SampleTriggerAndConditionType(int id, int eventRef, int selectedSubTriggerIndex, byte[] dataIn, TriggerTypeCollection.ITriggerTypeListener listener, bool logDebug = false) : base(id, eventRef, selectedSubTriggerIndex, dataIn, listener, logDebug) { }
        /// <inheritdoc />
        /// <remarks>
        /// All trigger types must implement this constructor
        /// </remarks>
        public SampleTriggerAndConditionType() { }
        ...
        /// <summary>
        /// This trigger can also be a condition
        /// </summary>
